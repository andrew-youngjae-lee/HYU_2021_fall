...
final class HttpRequest implements Runnable{
   ...
   private String parseRequestLine(String requestLine) {
      ...
      if(file.isDirectory()) {
         ...
         if(list == null || list.length == 0) {
            ...
            return "Found more than one index file at requested location " + fileName + ". Returning INTERNAL SERVER ERROR.";
         }
         file = list[0];
      ...
      if(version.equals("HTTP/1.0")) {
         ...
         return "HTTP version string is malformed. Retruning BAD REQUEST.";
      }
   ...
   private void sendResponseMessage(FileInputStream fis, DataOutputStream os)throws Exception{
      ...
      case HTTP_VERSION_NOT_SUPPORTED:
         message = "HTTP Version Not Suported";
         break;
      default:
      ...
      if(code != StatusCode.OK)
         entityBody = entityBody.replaceAll("\\?", message + " - sent by YoungJae's WebServer");
   ...
   private void sendHeaderLines(DataOutputStream os) throws Exception{
      ...
      case OK:
         ...
         contentTypeLine = contentTypeLine + requestedFile.length() + CRLF; // *mission 6
         break;
      default:
